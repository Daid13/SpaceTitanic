...
print(
    "Cabin matches A/0/A:",
    _matchCabins[_matchCabins == True].count(),
    _matchCabins[_matchCabins == False].count(),
    len(_matchCabins),
)
print(
    "PassengerId matches 0000_00:",
    _matchGroups[_matchGroups == True].count(),
    _matchGroups[_matchGroups == False].count(),
    len(_matchGroups),
)
